...
`table1` termasuk "Tidy data" karena memenuhi tiga ciri yaitu:, 1). Setiap variabel disimpan dalam masing-masing kolom berbeda; 2). Setiap observasi dinyatakan dalam satu baris; dan 3). Nilai dalam *cell* adalah unik untuk setiap kombinasi observasi dan variabel.

```{r}
table2
```

`table2` tidak termasuk "Tidy data" karena beberapa variabel pengamatan disimpan dalam satu kolom dengan cara ditumpuk.

```{r}
table3
```

`table3` tidak termasuk "Tidy data" karena nilai dari beberapa variabel pengamatan disimpan dalam satu kolom dengan cara "ditempel".
...
`table4a` tidak termasuk "Tidy data" karena nilai observasi dari variabel yang sama disimpan ke dalam kolom berbeda. Sehingga informasi data menjadi tidak jelas dan sulit dipahami secara langsung.

```{r}
table4b
```

`table4b` tidak termasuk "Tidy data" karena nilai observasi dari variabel yang sama disimpan ke dalam kolom berbeda. Sehingga informasi data menjadi tidak jelas dan sulit dipahami secara langsung.
...
`table5` tidak termasuk "Tidy data" karena nilai dari beberapa variabel pengamatan disimpan dalam satu kolom dengan cara "ditempel". Selain itu jenis data pada beberapa kolom tidak sesuai dengan "sifat" aslinya.
